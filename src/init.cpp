...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://UniAsset.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    if (!fTxIndex) {
        ...
        msg += ": " + GetConfigFile(GetArg("-conf", BITCOIN_CONF_FILENAME)).string() + "\n\n";
        ...
        if (fRet) {
            ...
            boost::filesystem::path configPathInfo = GetConfigFile(GetArg("-conf", BITCOIN_CONF_FILENAME));
