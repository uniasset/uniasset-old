...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/XXXX/uniasset/>";
    const std::string URL_WEBSITE = "<https://uniformfiscalobject.com/uniasset>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("UFOmnicore version %s\n", FormatFullVersion());
}
