...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_omni.data = "Omni serve as the binding between Ufobject, smart properties and contracts created on the Omni Layer.";
    ...
    implied_tomni.data = "Test Omni serve as the binding between Ufobject, smart properties and contracts created on the Omni Layer.";
