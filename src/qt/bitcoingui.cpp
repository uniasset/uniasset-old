...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send Omni Layer and UFO transactions"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and uniasset: URIs)"));
    ...
    **/
    ...
    openAction->setStatusTip(tr("Open a uniasset: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible UFOmnicore command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Uniform Fiscal Object Omni Core"); // default title
